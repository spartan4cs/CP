...
public class LL_palindrome_Or_note {
    ...
    public static class LinkedList {
        ...
        public boolean IsPalindrome() {
            ...
            // moved to middle r
            // slwo will be right end of midlle for even
            Node slow = head;
            Node fast = head;
            ...
            // move the slow to next if odd value;
            // for odd value /fast will not be at null
            if (fast != null) {
                slow = slow.next;
            }

            // slow ko reverse kardo
